...
export default function ModoFijoSetupScreen({ navigation }) {
  const [startIdx, setStartIdx] = useState('1');
  const [endIdx, setEndIdx] = useState('40');
  ...
  const handleStart = () => {
    ...
    // Pass the range to the quiz screen directly
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.setupContainer}>
        ...
        <Text style={styles.setupTitle}>Cuestionario Fijo</Text>
        ...
        <TouchableOpacity style={styles.startButton} onPress={handleStart}>
          ...
          <Text style={styles.startButtonText}>Iniciar Cuestionario</Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
